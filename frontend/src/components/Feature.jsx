    ...
    <div className="max-w-screen-2xl mx-20 mt-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-1 ml-4">
            ...
            <div className='w-2/5'>
                ...
                <p className='text-roboto text-[18px]'>Detection and counting of vehicle based on video using YOLO. 
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-1 ml-4">
            <div className='w-2/5'>
                ...
                <p className='text-roboto text-[18px]'>Classification of vehicles based on six categories.
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-1 ml-4">
            ...
            <div className='w-2/5'>
                ...
                <p className='text-roboto text-[18px]'>Dive into a comprehensive dashboard packed with valuable insights derived from your video data.
